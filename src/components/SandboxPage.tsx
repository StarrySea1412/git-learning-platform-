        ...
        <div className="space-y-4">
          ...
          <Terminal
            ...
            initialOutput={[
              ...
              '更多命令：restore / tag / diff / show / commit --amend / branch -m / branch -D / switch - / worktree add / rebase -i HEAD~n / submodule add',
              '子模块模拟：git submodule add <url> <path> 纳入外部仓库，init + update 完成克隆后的拉起。',
